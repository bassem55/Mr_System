...
@section("style")
    <link rel="stylesheet"  href="{{ asset('css/my_system.css') }}">
@endsection
@section("head_script")
...
@section('body')
    <div class="sys_name">{{ $sys_name }}</div>
...
@section('script')
    <script type="text/javascript" src="{{ asset('js/my_system_1.js')}}"></script>
    <script type="text/javascript" src="{{ asset('js/my_system_2.js')}}"></script>
@endsection